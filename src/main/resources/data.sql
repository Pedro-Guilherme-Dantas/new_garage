...
values (7, null , '20210215 08:00:00', 80, 1, 'PENDENTE', 'Limpeza e ajusta do carburador', 'MANUNTENCAO');

insert into tb_servicos (id, data_fim, data_inicio, valor, moto_id, status_servico, descricao, tipo_servico) 
values (8, null , '20210215 08:00:00', 225, 2, 'EM_ANDAMENTO', 'Moto fará revisão dos 25.000km', 'REVISAO');

insert into tb_servicos (id, data_fim, data_inicio, valor, moto_id, status_servico, descricao, tipo_servico) 
values (9, '20210215 15:05:06' , '20210215 08:00:00', 80, 1, 'FINALIZADO', 'Revisão dos 35.000km', 'REVISAO');

insert into tb_servicos (id, data_fim, data_inicio, valor, moto_id, status_servico, descricao, tipo_servico) 
values (10, '20210215 09:05:06' , '20210215 08:00:00', 225, 2,'CANCELADO', 'Moto fará revisão dos 25.000km', 'REVISAO');