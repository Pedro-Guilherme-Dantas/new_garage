...
insert into tb_moto (id, cilindrada, placa, quilometragem, modelo, ano) values (1, 150, 'asd-1234', 38000, 'mirage', 2012);
insert into tb_moto (id, cilindrada, placa, quilometragem, modelo, ano) values (2, 250, 'qwe-4566', 25800, 'lander', 2019);
...
insert into tb_servicos (id, data_fim, data_inicio, valor, cliente_id, moto_id, status_servico, descricao, tipo_servico) 
values (2, '20210215 09:05:06' , '20210215 08:00:00', 225, 2, 2, 'EM_ANDAMENTO', 'Moto fará revisão dos 25.000km', 'REVISAO');
